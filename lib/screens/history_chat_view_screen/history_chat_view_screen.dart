...
class _HistoryChatViewScreenState extends State<HistoryChatViewScreen> {
  ...
  final openAI = OpenAI.instance.build(token: openAiToken, baseOption: HttpSetup( receiveTimeout: const Duration(seconds: 6), connectTimeout: const Duration(seconds: 6), sendTimeout: const Duration(seconds: 6)), );
