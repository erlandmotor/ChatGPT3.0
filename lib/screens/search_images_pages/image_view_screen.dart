...
class ImageViewScreen extends StatelessWidget {
  String image;
  Map k;
  ImageViewScreen({Key? key, required this.image, required this.k})
      : super(key: key);
          ...
          children: [
            ...
            Row(
              children: [
                ...
                Obx(
                  () => button(
                      text: (searchScreenController.isLoading.value)
                      ...
                      onTap: () async {
                        await searchScreenController.insertImage(k: k);
  ...
  Widget button({required Widget text, required VoidCallback onTap}) {
    return Expanded(
