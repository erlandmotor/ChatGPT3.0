...
import 'package:chat_gpt/screens/hisrory_image_pages/history_dcreen.dart';
          ...
          body: SingleChildScrollView(
            child: Column(
              children: [
                          ...
                          child: Container(
                              ...
                              child: AppDropdown(
                                ...
                                items: searchScreenController
                                    ...
                                    .toList(),
                                onChanged:
                                    searchScreenController.onImageSizeChange,
                ...
                Obx(() => searchScreenController.isLoading.value == false &&
                              ...
                              child: Stack(
                                ...
                                children: [
                                  CachedNetworkImage(
                                    ...
                                    errorWidget: (context, error, u) => Center(
                                        child: CircularProgressIndicator(
                                            strokeWidth: 2,
                                            color: context
                                                .textTheme.headline1!.color)),
                                  ...
                                  Row(
                                    ...
                                    children: [
                                       InkWell(
                                        ...
                                        child:Obx(() => (searchScreenController.isLoading.value)?CircularProgressIndicator() :Container(
                                          height: 30,
                                          width: 30,
                                          decoration: BoxDecoration(
